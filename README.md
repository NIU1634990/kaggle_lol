...
├── kaggle.pdf         # Notebook en pdf per més llegibilitat
...
6. Models de classificació i predicció
    * 6.1. Línia base
    * 6.2. Pipelines
    * 6.3. Avaluacio amb GroupKFold
    * 6.4. Avaluació de mètriques i experiments
    * 6.5. Entrenament del millor model
    * 6.6. Gràfics (visualització dels resultats)
7. Conclusions
...
Regressió logística ha sortit com el millor model.
